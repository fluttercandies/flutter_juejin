...
UserPassportModel _$UserPassportModelFromJson(Map<String, dynamic> json) =>
    UserPassportModel(
      ...
      odinUserType: json['odin_user_type'] as int,
      name: json['name'] as String,
      screenName: json['screen_name'] as String,
      avatarUrl: json['avatar_url'] as String,
      userVerified: json['user_verified'] as bool,
      emailCollected: json['email_collected'] as bool,
      phoneCollected: json['phone_collected'] as bool,
      ...
      isBlocking: json['is_blocking'] as int,
      ...
      canBeFoundByPhone: json['can_be_found_by_phone'] as int,
      ...
      isRecommendAllowed: json['is_recommend_allowed'] as int,
      ...
      visitCountRecent: json['visit_count_recent'] as int,
      skipEditProfile: json['skip_edit_profile'] as int,
      isManualSetUserInfo: json['is_manual_set_user_info'] as bool,
      deviceId: json['device_id'] as int,
      countryCode: json['country_code'] as int,
      hasPassword: json['has_password'] as int,
      shareToRepost: json['share_to_repost'] as int,
      userDecoration: json['user_decoration'] as int,
      userPrivacyExtend: json['user_privacy_extend'] as int,
      ...
      vcdAccount: json['vcd_account'] as int,
      vcdRelation: json['vcd_relation'] as int,
      canBindVisitorAccount: json['can_bind_visitor_account'] as bool,
      isVisitorAccount: json['is_visitor_account'] as bool,
      isOnlyBindIns: json['is_only_bind_ins'] as bool,
      userDeviceRecordStatus: json['user_device_record_status'] as int,
      isKidsMode: json['is_kids_mode'] as int,
      isEmployee: json['is_employee'] as bool,
      passportEnterpriseUserType: json['passport_enterprise_user_type'] as int,
      needDeviceCreate: json['need_device_create'] as int,
      needTtwidMigration: json['need_ttwid_migration'] as int,
      userAuthStatus: json['user_auth_status'] as int,
      userSafeMobile2Fa: json['user_safe_mobile2_fa'] as String,
      safeMobileCountryCode: json['safe_mobile_country_code'] as int,
      liteUserInfoString: json['lite_user_info_string'] as String,
      liteUserInfoDemotion: json['lite_user_info_demotion'] as int,
      appUserInfo: json['app_user_info'] as Json?,
    );
